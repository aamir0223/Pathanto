<title>Class Wise NCERT Summaries -pathanto.com</title>
<meta name="description" content="Hey there, welcome to our chapter summary page! Here, you'll find condensed summaries of all the chapters covered in our science curriculum. Whether you're in class 6, 7, 8, 9, or 10, these summaries are designed to give you a quick overview of each chapter's key concepts and main points  Chapter wise summaries for Class 6 to 10 ">
      ...
      <meta name="og:title" content="Class Wise NCERT Summaries -pathanto.com ">
...
<script>
 ...
 <div class="wrapper">
  ...
  include "./../config.php";
    // Fetch all distinct classes and subjects from the database
    $sql = "SELECT DISTINCT class, subject FROM Chapters";
    $result = $conn->query($sql);

    if ($result->num_rows > 0) {
        // Display list of classes and subjects
        ...
        while ($row = $result->fetch_assoc()) {
             ...
             <div class='card mcq-card'>
               <a href='chapter-selection?class=" . $row['class'] . "&subject=" . $row['subject'] . "'>
                    <div class='card-body'>
                       
                        <h2> " . $row['class'] . " - " . $row['subject'] . " </h2>
                    </div>
                </a>
            </div>";
        ...
        // No classes and subjects found
        echo "No classes and subjects found.";
    }
    ?>
